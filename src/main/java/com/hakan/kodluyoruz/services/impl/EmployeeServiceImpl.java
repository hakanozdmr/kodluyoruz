package com.hakan.kodluyoruz.services.impl;

import com.hakan.kodluyoruz.dto.EmployeeDto;
import com.hakan.kodluyoruz.entity.EmployeeEntity;
import com.hakan.kodluyoruz.exception.ResourceNotFoundException;
import com.hakan.kodluyoruz.repository.EmployeeRepository;
import com.hakan.kodluyoruz.services.EmployeeServices;
...
public class EmployeeServiceImpl implements EmployeeServices {
    ...
    public ResponseEntity<EmployeeDto> updateEmployee(@PathVariable(name = "id") Long id, @RequestBody EmployeeDto employeeDetails){
        ...
        employee.setEmailName(employeeEntity.getEmailName());
